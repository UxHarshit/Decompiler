...
//const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Smali()
//{
//	static bool inited = false;
//	static LanguageDefinition langDef;
//	if (!inited)
//	{
//		static const char* const smaliKeywords[] = { 
//			"class", "super", "line", "invoke-direct", "invoke-static", "invoke-virtual", "invoke-super", "invoke-interface", 
//			"if-eq", "if-ne", "if-lt", "if-ge", "if-gt", "if-le", "if-eqz", "if-nez", "if-ltz", "if-gez", "if-gtz", "if-lez" 
//		};
//			
//		for (auto& k : smaliKeywords)
//			langDef.mKeywords.insert(k);
//
//		static const char* const identifiers[] = {
//			"source","super","class"
//			 "Ljava/lang/Object;","Ljava/lang/String;", "Ljava/lang/Integer;","Ljava/lang/Boolean;","Ljava/util/List;",
//			"Ljava/util/Map;",
//			"I","V","Z","B","C","S","D","F","J" 
//		};
//		for (auto& k : identifiers)
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Smali()
{
	...
	{
		static const char* const smaliKeywords[] = {
			"source", "super", "line", "invoke-direct", "invoke-static", "invoke-virtual", "invoke-super", "invoke-interface",
			"if-eq", "if-ne", "if-lt", "if-ge", "if-gt", "if-le", "if-eqz", "if-nez", "if-ltz", "if-gez", "if-gtz", "if",
			"if-eqz", "if-nez", "if-ltz", "if-gez", "if-gtz", "if" };
		for (auto& k : smaliKeywords)
			langDef.mKeywords.insert(k);
